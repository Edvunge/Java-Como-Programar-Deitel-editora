...
R) Os comentarios são utilizados para documentar um programa e aprimorar sua legibilidade.

b) Uma decisão pode ser tomada em um programa Java com um(a) ________.
R) Uma decisão pode ser tomada em um programa Java com uma estrutura de decisao.

c) Os cálculos normalmente são realizados pelas instruções ________.
R)  Os cálculos normalmente são realizados pelos operadores aritmeticos.
